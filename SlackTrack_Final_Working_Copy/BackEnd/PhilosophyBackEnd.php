...
the table that displays grade information for the desired class within the Philosophy major. This page was written by 
...
This page is called by the PhilosophyPopup.js file housed in the js folder. PhilosophyPopup.js passes this file the desired class name
...
HTML table which is passed back to the PhilosophyPopup.js file to then be displayed in the Philosophy.php page in the front end folder.
 *
 */
...
//In PhilosophyPopup.js we pass data the class name data to this file. The below $_GET is listening for this data. If it is recieved
...
//If it fails, it will return the error message provided by SQL.
 try{
//The below is a SQL query that selects everything from the Philosophy table housed in the SlackTrack database whose course number 
//matches the one originally passed to this file which was stored at the $course variable. 
  $sql = "SELECT * FROM Philosophy where NUMBER= $course ORDER BY (AM+A+AP)/TOT_NON_W DESC;";
