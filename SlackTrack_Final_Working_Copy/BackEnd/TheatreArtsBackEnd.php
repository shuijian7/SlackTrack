...
the table that displays grade information for the desired class within the Theatre Arts major. This page was written by 
...
This page is called by the TheatreArtsPopup.js file housed in the js folder. TheatreArtsPopup.js passes this file the desired class name
...
HTML table which is passed back to the TheatreArtsPopup.js file to then be displayed in theTheatreArts.php page in the front end folder.
 *
 */
...
//In TheatreArtsPopup.js we pass data the class name data to this file. The below $_GET is listening for this data. If it is recieved
...
//The below is a SQL query that selects everything from the Theater table housed in the SlackTrack database whose course number 
//matches the one originally passed to this file which was stored at the $course variable. 
  $sql = "SELECT * FROM Theater where NUMBER= $course ORDER BY (AM+A+AP)/TOT_NON_W DESC;";
