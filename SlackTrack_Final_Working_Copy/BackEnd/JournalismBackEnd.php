...
This page is called by the JournalismPopup.js file housed in the js folder. JournalismPopup.js passes this file the desired class name
...
//TThe variables housed in config.php are passed into the PDO function which formats them to be ready to be used to connect
//to the database. This formatted connection is then stored in a variable called connection.
$connection = new PDO($dsn, $username, $password, $options);

//In JournalismPopup.js we pass data the class name data to this file. The below $_GET is listening for this data. If it is recieved
...
-->
            ...
            <tr>
                ...
                <td><?php echo escape(percent(round(($value["W"])/($value["TOT_NON_W"]+$value["TOT_NON_W"]),2))); ?></td>
